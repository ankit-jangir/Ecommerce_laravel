<footer class="footer border-t border-gray-300 bg-[#F5F1EB] text-[#654321] relative pt-4 sm:pt-10 lg:pt-16">
    <div class="container  mx-auto px-4 sm:px-6 lg:px-8 pb-10 sm:pb-16">
        <!-- Main Footer Content -->
