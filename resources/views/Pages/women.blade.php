...
@section('title', 'Women Collection - AURA KURTIS')
...
// Women-specific subcategories
$womenSubcategories = ['Printed Kurtis', 'Anarkali Kurtis', 'Cotton Kurtis', 'Festive Kurtis', 'Kurti Sets', 'Tops', 'Dresses', 'Bottoms'];

// Category mapping for women's products
$categoryMapping = [
    ...
    'Tops' => ['Tops', 'Casual Wear'],
    'Dresses' => ['Dresses', 'Festive Wear'],
    'Bottoms' => ['Bottoms', 'Trousers'],
];

// Add hover images and assign to women subcategories
$productsWithHover = [];
foreach ($products as $index => $product) {
    ...
    // Distribute products evenly across women subcategories
    $subcatIndex = $index % count($womenSubcategories);
    $product['subcategory'] = $womenSubcategories[$subcatIndex] ?? $assignedSubcategory;
    // Don't filter by category initially - show all products, but keep category for filtering
    ...
    <div class="relative container mx-auto px-4 sm:px-6 h-full flex items-center justify-center text-center">
        <div class="text-white max-w-3xl">
            ...
            <p class="mt-4 text-sm sm:text-base text-gray-200 max-w-2xl mx-auto">
                Discover elegant kurtis, tops, dresses and bottoms crafted for modern women
            </p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <aside class="lg:col-span-1">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-2 sm:p-3 lg:p-6 space-y-3 sm:space-y-4 lg:space-y-6 sticky top-24 hidden lg:block" id="filter-sidebar" data-mobile-hidden="true">
                    ...
                    <!-- CATEGORY - Only Women Subcategories -->
                        ...
                        <div class="space-y-1">
                            <details class="group" open>
                                ...
                                <div class="pl-2 mt-1 sm:mt-2 space-y-1 sm:space-y-2">
                                    @foreach($womenSubcategories as $subcat)
...
<section class="py-6 sm:py-8 lg:py-12 bg-white border-t border-gray-200">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-4 sm:mb-6">
            ...
            <p class="text-xs sm:text-sm text-gray-600">Explore our women's fashion collection</p>
        </div>
            ...
            <div class="flex gap-3 sm:gap-4 lg:gap-6 min-w-max justify-center lg:justify-center">
                ...
                $categoryList = [
                    'Printed Kurtis' => [
                        ...
                        'route' => route('women') . '?category[]=Printed Kurtis'
                    ],
                    'Anarkali Kurtis' => [
                        'name' => 'Anarkali Kurtis',
                        'image' => 'https://images.unsplash.com/photo-1594633312680-c5d69d0c0e9b?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Anarkali Kurtis'
                    ],
                    'Cotton Kurtis' => [
                        'name' => 'Cotton Kurtis',
                        'image' => 'https://images.unsplash.com/photo-1594633313593-bab3825d0caf?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Cotton Kurtis'
                    ],
                    'Festive Kurtis' => [
                        'name' => 'Festive Kurtis',
                        'image' => 'https://images.unsplash.com/photo-1594633312680-c5d69d0c0e9b?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Festive Kurtis'
                    ],
                    'Kurti Sets' => [
                        'name' => 'Kurti Sets',
                        'image' => 'https://images.unsplash.com/photo-1594633313593-bab3825d0caf?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Kurti Sets'
                    ],
                    'Tops' => [
                        'name' => 'Tops',
                        'image' => 'https://images.unsplash.com/photo-1594633312680-c5d69d0c0e9b?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Tops'
                    ],
                    'Dresses' => [
                        'name' => 'Dresses',
                        'image' => 'https://images.unsplash.com/photo-1594633313593-bab3825d0caf?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Dresses'
                    ],
                    'Bottoms' => [
                        'name' => 'Bottoms',
                        'image' => 'https://images.unsplash.com/photo-1594633312680-c5d69d0c0e9b?w=200&h=200&fit=crop',
                        'route' => route('women') . '?category[]=Bottoms'
                    ],
                ];
                @endphp
