...
@section('title', 'Women - AURA KURTIS')

@section('content')
    <!-- Page Header -->
    <section class="bg-white py-12">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl font-light text-gray-900">WOMEN</h1>
            <p class="text-gray-600 mt-2">Discover our elegant collection</p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <button class="text-sm text-gray-700 hover:text-gray-900">Kurtis</button>
                    <button class="text-sm text-gray-700 hover:text-gray-900">Tops</button>
                    <button class="text-sm text-gray-700 hover:text-gray-900">Dresses</button>
                </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="product-card group cursor-pointer">
                    ...
                    <p class="text-gray-600 mb-2">Elegant and comfortable design</p>
                    <div class="flex items-center gap-2">
                        <p class="text-gray-900 font-semibold">₹{{ 1999 + ($i * 100) }}</p>
                        @if($i % 3 == 0)
                        <span class="text-sm text-red-600 line-through">₹{{ 2999 + ($i * 100) }}</span>
                        <span class="text-sm bg-yellow-400 px-2 py-1 rounded">50% OFF</span>
                        @endif
                    </div>
                </div>
                @endfor
