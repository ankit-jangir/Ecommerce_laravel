...
<section class="relative h-[520px] overflow-hidden">
    ...
    <div class="relative container mx-auto px-6 h-full flex items-center">
        <div class="text-white max-w-xl">
            ...
            <h1 class="text-5xl font-light mt-4">Timeless <span class="font-semibold">Kurta Collection</span></h1>
            <p class="mt-4 text-gray-200">Discover Premium Men's Kurta modern lifestyle</p>
        </div>
    </div>
</section>
