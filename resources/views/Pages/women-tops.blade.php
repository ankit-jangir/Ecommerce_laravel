...
@section('title', 'Women Tops Collection - AURA')
...
<section class="relative overflow-hidden">
    ...
    <div class="absolute inset-0 flex items-center justify-center">
        <div class="bg-white/90 px-10 py-10 rounded-2xl text-center max-w-xl">
            ...
            <h1 class="text-4xl font-serif font-bold text-[#654321] mt-4">Women Tops Collection</h1>
            <p class="text-sm text-gray-700 mt-3">
                Discover tops crafted for modern women.
            </p>
        </div>
    </div>
</section>
