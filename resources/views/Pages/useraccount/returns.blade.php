...
@section('title', 'Returns - AURA KURTIS')
...
@section('content')
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="flex-1 min-w-0">
                    <h1 class="text-2xl sm:text-3xl font-serif font-bold text-[#654321] mb-6">Returns & Exchanges</h1>
    ...
    <script src="{{ asset('js/account-returns.js') }}"></script>
@endsection
