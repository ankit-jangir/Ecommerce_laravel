...
@section('title', 'Track Order - AURA KURTIS')
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-serif font-bold text-[#654321] mb-6">Track Order</h1>
                    <div id="track-order-content" class="bg-white rounded-xl shadow-lg p-4 sm:p-6">
