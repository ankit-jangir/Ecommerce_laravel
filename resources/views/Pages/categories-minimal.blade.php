...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            $products = [
            ['name'=>'Oversized
            Hoodie','price'=>2299,'img'=>'https://images.unsplash.com/photo-1520975661595-6453be3f7070'],
            ['name'=>'Streetwear
            Kurti','price'=>2499,'img'=>'https://images.unsplash.com/photo-1594633313593-bab3825d0caf'],
            ['name'=>'Casual
            Shirt','price'=>1899,'img'=>'https://images.unsplash.com/photo-1617137968427-85924c800a22'],
            ['name'=>'Fusion
            Dress','price'=>2799,'img'=>'https://images.unsplash.com/photo-1483985988355-763728e1935b'],
            ['name'=>'Denim
            Co-ord','price'=>2599,'img'=>'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c'],
            ['name'=>'Minimal Tee','price'=>1499,'img'=>'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'],
            ['name'=>'Kids Street
            Set','price'=>1999,'img'=>'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf'],
            ['name'=>'Unisex
            Jacket','price'=>2999,'img'=>'https://images.unsplash.com/photo-1520974735194-6c7b5f41f0a2'],
            ];
            @endphp
