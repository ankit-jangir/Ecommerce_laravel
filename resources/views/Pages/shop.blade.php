    ...
    @php
        $products = [
            [
                ...
                'image' =>
                    'https://khatricreations.com/cdn/shop/files/KC200246_1.png?crop=center&height=2389&v=1764854172&width=1792',
                'price' => 999,
                'old_price' => 1999,
                'badge' => 'SALE',
                'badge_value' => '-52%',
            ...
            [
                ...
                'image' =>
                    'https://stylejaipur.com/cdn/shop/files/PHOTO-2023-10-09-21-02-48.jpg?v=1728409404&width=533',
                'price' => 1499,
                'old_price' => 799,
                'badge' => 'NEW',
            ],
            [
                ...
                'image' =>
                    'https://stylejaipur.com/cdn/shop/files/WhatsAppImage2023-09-29at11.24.49PM.jpg?v=1728409204&width=533',
                'price' => 899,
                'old_price' => 799,
                'badge' => 'TRENDING',
            ],
            [
                ...
                'image' =>
                    'https://stylejaipur.com/cdn/shop/files/21474dae-2c13-4f39-8fad-52a8c414a7b6.jpg?v=1728890097&width=533',
                'price' => 1899,
                'old_price' => 2499,
                'badge' => 'SALE',
                'badge_value' => '-25%',
    ...
    <img src="{{ $product['image'] }}"
         class="w-full h-[420px] object-cover transition duration-500 group-hover:scale-105">
                        ...
                        {{ $product['badge'] == 'TRENDING' ? 'bg-orange-500 text-white' : '' }}">
                                ...
                                <!-- HOVER ICONS -->
                                <div
                                    class="absolute top-4 right-4 flex flex-col gap-3 opacity-0 translate-x-6
